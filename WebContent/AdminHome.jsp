...
<!-- TO MAKE THE URL REFERENCES WORK YOU MUST HAVE SESSION ID DISABLED IN URL - SEE WEB.XML -->
      ...
      <div class="logo"><h1><a href="<c:url value='/' />">Back to Home Page</a></h1></div>
  <div class="content">  
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="searchUserProfileforAdmin.jsp"  target="_top"><span>Search User</span></a></li>  
           <li><a href="formSearchUser.jsp"  target="_top"><span>View Available Parking Spaces</span></a></li>  
